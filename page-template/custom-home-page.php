...
<main id="maincontent" role="main">
                  ...
                  <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                    ...
                    <div class="carousel-caption">
                      <div class="inner_carousel">
                        <h1 class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> wow slideInRight delay-1000" data-wow-duration="2s"<?php } else { ?> heading <?php } ?>"><a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
                        <p class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> wow slideInRight delay-1000" data-wow-duration="2s"<?php } else { ?> cont <?php } ?>"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_ecommerce_store_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_ecommerce_store_slider_excerpt_number','30')))); ?></p>
                        <?php if( get_theme_mod('vw_ecommerce_store_slider_button_text','SHOP NOW') != ''){ ?>
                          <div class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> slider-btn wow slideInRight delay-1000" data-wow-duration="2s"<?php } else { ?> slider-btn <?php } ?>">
                  ...
                  <div class="col-lg-12 col-md-6">
                    <div class="carousel-inner1" role="listbox">
                      ...
                      <div class="carousel-caption1">
                        <h3 class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> wow zoomInDown delay-1000" data-wow-duration="2s"<?php } else { ?> heading <?php } ?>"><?php the_title(); ?></h3>
                        <?php if( get_theme_mod('vw_ecommerce_store_sale_banner_button_text','SHOP NOW') != ''){ ?>
                          <div class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> wow zoomInDown delay-1000" data-wow-duration="2s"<?php } else { ?> head <?php } ?>">
  ...
  <?php do_action( 'vw_ecommerce_store_after_slider' ); ?>
   ...
   <section id="serv-section" class="<?php if( get_theme_mod( 'vw_ecommerce_store_animation', true) != '') { ?> wow zoomInUp delay-1000" data-wow-duration="2s"<?php } else { ?> serv <?php } ?>"> 
    <div class="container">
