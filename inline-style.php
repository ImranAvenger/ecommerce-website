<?php
	...
	$vw_ecommerce_store_nav_menus_font_weight = get_theme_mod( 'vw_ecommerce_store_navigation_menu_font_weight','Default');
    if($vw_ecommerce_store_nav_menus_font_weight == 'Default'){
		$vw_ecommerce_store_custom_css .='.main-navigation a{';
			$vw_ecommerce_store_custom_css .='';
		$vw_ecommerce_store_custom_css .='}';
	}else if($vw_ecommerce_store_nav_menus_font_weight == 'Normal'){
		$vw_ecommerce_store_custom_css .='.main-navigation a{';
			$vw_ecommerce_store_custom_css .='font-weight: normal;';
		$vw_ecommerce_store_custom_css .='}';
	}
